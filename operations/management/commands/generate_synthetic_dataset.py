...
ANOMALY_SCENARIOS = {
    'HIGH_TEMPERATURE': {
        'temperature': (86, 100),
        'energy_consumption': (66, 90),
        'production_quality_score': (50, 75),
        'machine_speed': (900, 1200),
        'vibration_level': (1, 4),
        'humidity': (40, 60),
        'pressure': (2, 4),
        'production_volume': (50, 75),
    },
    'MACHINE_STRESS': {
        'temperature': (80, 95),
        'vibration_level': (7.5, 12),
        'machine_speed': (700, 1000),
        'energy_consumption': (50, 75),
        'production_quality_score': (60, 80),
        'humidity': (40, 60),
        'pressure': (3, 5),
        'production_volume': (45, 70),
    },
    'ENERGY_SPIKE': {
        'energy_consumption': (75, 100),
        'production_volume': (40, 65),
        'temperature': (60, 80),
        'machine_speed': (1000, 1400),
        'vibration_level': (1, 5),
        'humidity': (40, 65),
        'pressure': (2, 4),
        'production_quality_score': (70, 90),
    },
    'QUALITY_DROP': {
        'production_quality_score': (30, 70),
        'temperature': (60, 80),
        'machine_speed': (900, 1300),
        'vibration_level': (1, 5),
        'energy_consumption': (35, 55),
        'humidity': (40, 65),
        'pressure': (2, 4),
        'production_volume': (50, 85),
    },
    'HUMIDITY_PRESSURE_ISSUE': {
        ...
        'machine_speed': (1000, 1400),
        'vibration_level': (1, 5),
        'energy_consumption': (35, 60),
        'production_quality_score': (65, 85),
        'production_volume': (50, 85),
    },
    'PRODUCTION_DROP': {
        'production_volume': (20, 45),
        'energy_consumption': (55, 80),
        'temperature': (65, 85),
        'machine_speed': (800, 1100),
        'vibration_level': (1, 6),
        'humidity': (40, 65),
        'pressure': (2, 5),
        'production_quality_score': (60, 85),
    },
}

NORMAL_RANGES = {
    'temperature': (55, 80),
    'machine_speed': (1200, 1600),
    'vibration_level': (0.01, 3.5),
    'energy_consumption': (1, 55),
    'production_quality_score': (85, 100),
    'humidity': (40, 65),
    'pressure': (2, 4.5),
    'production_volume': (65, 100),
}
